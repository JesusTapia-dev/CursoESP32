...
const char* ssid = "DESKTOP";  // Enter SSID here
...
void setup() {
  ...
  Serial.print("La dirección IP es: ");  Serial.println(WiFi.localIP());
...
String SendHTML(uint8_t led1stat,uint8_t led2stat){
  ...
  ptr +="<h1>ESP32 Servidor Web</h1>\n";
    ptr +="<h3>Usando Station Mode (STA)</h3>\n";
  
   if(led1stat)
  {ptr +="<p> Estado del LED1: ON</p><a class=\"button button-off\" href=\"/led1off\">OFF</a>\n";}
  else
